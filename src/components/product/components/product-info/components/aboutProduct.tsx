      ...
      >
        ...
        <div className={'order-6 flex gap-3 flex-col'}>
          <p>
            ...
            accusantium adipisci alias asperiores aspernatur atque autem beatae
            commodi consequatur cumque cupiditate delectus doloremque doloribus
            dolorum, ducimus ea earum eius eligendi eos error est eum eveniet
            excepturi exercitationem expedita explicabo facere fugiat fugit
            harum hic illum impedit in incidunt ipsa ipsum iure laboriosam
            laborum
          </p>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus,
